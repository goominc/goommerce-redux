...
function updateOrderProductStock(brandId, orderId, orderProductId, quantity) {
  var update = loadBrandOrder(brandId, orderId);
  return function (dispatch, getState) {
    var state = getState();
    return _goommerceApiClient.orderApi.updateOrderProductStock(state.auth, { orderProductId: orderProductId, quantity: quantity }).then(function () {
